...
export default function AISolutions() {
    const t = useTranslations('pages.aiSolutions');
    useEffect(() => {
        ...
        <main className="relative bg-white min-h-screen font-sans">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 lg:gap-6 h-auto md:h-[600px]" data-motion-stagger="0.1">
                        ...
                        <a href="#business-growth" {...withDelay(motionConfig.slideUp, 0.2)} className="group relative md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden shadow-lg border border-sky-blue/10 bg-white p-8 flex flex-col justify-between hover:scale-[1.01] hover:shadow-2xl transition-all duration-300">
                            <div>
                                ...
                                <h3 className="text-3xl font-display font-medium text-navy-blue mb-2 group-hover:text-sky-blue transition-colors">{t('grid.growth.title')}</h3>
                                <p className="text-neutral-gray max-w-sm">{t('grid.growth.description')}</p>
                            </div>
                            <div className="flex items-center text-sky-blue font-semibold text-sm mt-4 group-hover:translate-x-2 transition-transform">
                                {t('grid.growth.cta')} <span className="ml-2">→</span>
                            </div>
                        </a>
                        ...
                        <a href="#agentic-architecture" {...withDelay(motionConfig.scaleIn, 0.3)} className="group relative md:col-span-1 md:row-span-1 rounded-3xl overflow-hidden shadow-md border border-sky-blue/10 bg-slate-50 p-6 flex flex-col justify-between hover:scale-[1.02] hover:shadow-xl transition-all duration-300 hover:bg-white">
                            ...
                            <div>
                                <h4 className="text-lg font-bold text-navy-blue mb-1">{t('grid.agentic.title')}</h4>
                                <p className="text-xs text-neutral-gray">{t('grid.agentic.description')}</p>
                            </div>
                        </a>
                        ...
                        <a href="#rag-architecture" {...withDelay(motionConfig.slideRight, 0.4)} className="group relative md:col-span-1 md:row-span-2 rounded-3xl overflow-hidden shadow-lg border border-sky-blue/10 bg-sky-blue/5 p-6 flex flex-col justify-between hover:scale-[1.02] hover:shadow-xl transition-all duration-300 hover:bg-sky-blue/10">
                            ...
                            <div>
                                ...
                                <h3 className="text-xl font-display font-medium text-navy-blue mb-2">{t('grid.rag.title')}</h3>
                                <p className="text-sm text-neutral-gray leading-relaxed">
                                    {t('grid.rag.description')}
                                </p>
                            </div>
                            <div className="mt-4">
                        ...
                        <a href="#workflow-automation" {...withDelay(motionConfig.scaleIn, 0.5)} className="group relative md:col-span-1 md:row-span-1 rounded-3xl overflow-hidden shadow-md border border-sky-blue/10 bg-slate-50 p-6 flex flex-col justify-between hover:scale-[1.02] hover:shadow-xl transition-all duration-300 hover:bg-white">
                            ...
                            <div>
                                <h4 className="text-lg font-bold text-navy-blue mb-1">{t('grid.automation.title')}</h4>
                                <p className="text-xs text-neutral-gray">{t('grid.automation.description')}</p>
                            </div>
                        </a>
                        ...
                        <a href="#cost-optimization" {...withDelay(motionConfig.fadeIn, 0.6)} className="group relative md:col-span-2 md:row-span-1 rounded-3xl overflow-hidden shadow-md border border-sky-blue/10 bg-navy-blue p-6 flex items-center gap-6 hover:scale-[1.01] hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex-1">
                                <h3 className="text-xl font-bold text-white mb-1">{t('grid.cost.title')}</h3>
                                <p className="text-sm text-gray-300">{t('grid.cost.description')}</p>
                            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div {...motionConfig.slideLeft} className="ai-solution-growth-slideLeft">
                            <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">
                                {t('growth.title')} <span className="text-sky-blue">{t('growth.titleHighlight')}</span>
                            </h2>
                            ...
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-neutral-gray">{t('growth.items.personalized')}</span>
                                </li>
                                <li className="flex items-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sky-blue mr-3 mt-1 flex-shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
                                    <span className="text-neutral-gray">{t('growth.items.predictive')}</span>
                                </li>
                                <li className="flex items-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sky-blue mr-3 mt-1 flex-shrink-0"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
                                    <span className="text-neutral-gray">{t('growth.items.automated')}</span>
                                </li>
                            </ul>
                        </div>
                        <div {...motionConfig.slideRight} className="ai-solution-growth-slideRight relative rounded-3xl overflow-hidden shadow-2xl bg-slate-50 border border-sky-blue/10 p-8">
                            <div className="grid grid-cols-3 gap-4">
                                <div className="text-center p-4 bg-white rounded-lg">
                                    ...
                                    <p className="text-xs font-bold text-neutral-gray">{t('growth.stats.insights')}</p>
                                </div>
                                <div className="text-center p-4 bg-white rounded-lg">
                                    ...
                                    <p className="text-xs font-bold text-neutral-gray">{t('growth.stats.actions')}</p>
                                </div>
                                <div className="text-center p-4 bg-white rounded-lg">
                                    ...
                                    <p className="text-xs font-bold text-neutral-gray">{t('growth.stats.growth')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-slate-50 border-y border-sky-blue/10" id="agentic-architecture">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16" {...motionConfig.fadeIn}>
                        <span className="text-sky-blue font-bold tracking-widest uppercase text-xs mb-3 block">{t('agentic.badge')}</span>
                        <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">{t('agentic.title')}</h2>
                    ...
                    <div className="relative bg-white rounded-3xl p-8 lg:p-12 shadow-xl border border-sky-blue/10 overflow-hidden" {...withDelay(motionConfig.slideUp, 0.2)}>
                        <div className="grid lg:grid-cols-3 gap-8">
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-blue mb-2">{t('agentic.features.orchestrator.title')}</h4>
                                    <p className="text-sm text-neutral-gray">{t('agentic.features.orchestrator.description')}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-blue mb-2">{t('agentic.features.agents.title')}</h4>
                                    <p className="text-sm text-neutral-gray">{t('agentic.features.agents.description')}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-blue mb-2">{t('agentic.features.feedback.title')}</h4>
                                    <p className="text-sm text-neutral-gray">{t('agentic.features.feedback.description')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div {...motionConfig.slideLeft}>
                            ...
                            <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">{t('rag.title')}</h2>
                            <p className="text-lg text-neutral-gray mb-8 leading-relaxed">
                                {t('rag.description')}
                            </p>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-navy-blue">{t('rag.features.ingestion.title')}</h4>
                                        <p className="text-sm text-neutral-gray">{t('rag.features.ingestion.description')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-navy-blue">{t('rag.features.vector.title')}</h4>
                                        <p className="text-sm text-neutral-gray">{t('rag.features.vector.description')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-navy-blue">{t('rag.features.api.title')}</h4>
                                        <p className="text-sm text-neutral-gray">{t('rag.features.api.description')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-white rounded-xl p-6 border border-sky-blue/10">
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-sm">
                                        ...
                                        <span className="font-bold text-xs text-navy-blue uppercase tracking-wider">{t('rag.status.title')}</span>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-xs text-neutral-gray">
                                            <span>{t('rag.status.latency')}</span>
                                            <span className="text-navy-blue font-mono font-bold">45ms</span>
                                        </div>
                                        <div className="flex justify-between text-xs text-neutral-gray">
                                            <span>{t('rag.status.tokens')}</span>
                                            <span className="text-navy-blue font-mono font-bold">12k/sec</span>
                                        </div>
                                        <div className="flex justify-between text-xs text-neutral-gray">
                                            <span>{t('rag.status.accuracy')}</span>
            ...
            <section className="py-24 bg-slate-50" id="workflow-automation">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-16" {...motionConfig.fadeIn}>
                        <h2 className="font-display text-4xl lg:text-5xl text-navy-blue mb-6">{t('automation.title')}</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" data-motion-stagger="0.1">
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border border-sky-blue/10 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('automation.steps.trigger.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('automation.steps.trigger.description')}</p>
                        </div>
                        ...
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border-2 border-sky-blue/20 hover:-translate-y-2 transition-transform duration-300 relative">
                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-sky-blue text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">{t('automation.steps.analysis.badge')}</div>
                            <div className="w-12 h-12 bg-sky-blue/10 rounded-xl flex items-center justify-center text-sky-blue mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-2.54Z" /><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-2.54Z" /></svg>
                            </div>
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('automation.steps.analysis.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('automation.steps.analysis.description')}</p>
                        </div>
                        ...
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border border-sky-blue/10 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('automation.steps.erp.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('automation.steps.erp.description')}</p>
                        </div>
                        ...
                        <div {...motionConfig.slideUp} className="bg-white p-6 rounded-2xl shadow-lg border border-sky-blue/10 hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="font-bold text-lg text-navy-blue mb-2">{t('automation.steps.completion.title')}</h3>
                            <p className="text-sm text-neutral-gray">{t('automation.steps.completion.description')}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-navy-blue text-white relative overflow-hidden" id="cost-optimization">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div {...motionConfig.slideLeft}>
                            <h2 className="font-display text-4xl lg:text-5xl mb-6">{t('cost.title')}</h2>
                            <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                                {t('cost.description')}
                            </p>
                            <div className="grid grid-cols-2 gap-8 mb-8">
                                <div>
                                    <div className="text-4xl font-display font-bold mb-2 text-sky-blue">{t('cost.stats.operational.value')}</div>
                                    <p className="text-sm opacity-80 uppercase tracking-widest">{t('cost.stats.operational.label')}</p>
                                </div>
                                <div>
                                    <div className="text-4xl font-display font-bold mb-2 text-sky-blue">{t('cost.stats.efficiency.value')}</div>
                                    <p className="text-sm opacity-80 uppercase tracking-widest">{t('cost.stats.efficiency.label')}</p>
                                </div>
                            </div>
                        ...
                        <div {...motionConfig.slideRight} className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                            ...
                            <div className="mt-6 flex justify-between items-center text-sm">
                                <span className="opacity-70">{t('cost.chart.legacy')}</span>
                                <span className="font-bold text-sky-blue">{t('cost.chart.optimized')}</span>
                            </div>
                        </div>
                    </div>
                </div>
